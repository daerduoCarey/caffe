...
cub_net = caffe.Net(caffe_root + 'models/CUB_googLeNet_ST/deploy2.prototxt',
                    caffe_root + 'models/CUB_googLeNet_ST/CUB_googLeNet_ST_iter_1000.caffemodel.backup', 
		    caffe.TEST)
...
cub_net.save(caffe_root + 'models/CUB_googLeNet_ST/init_CUB_googLeNet_ST.caffemodel')
